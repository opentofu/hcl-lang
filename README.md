...
## Credits
Hashicorp Terraform - creating the [hcl-lang language server](https://github.com/hashicorp/hcl-lang), which was used as a starting point and inspiration for this language server.
